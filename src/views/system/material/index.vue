<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="materialList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="父主键" align="center" prop="parentId" />
      <el-table-column label="名字" align="center" prop="name" />
      <el-table-column label="类型" align="center" prop="type" />
      <el-table-column label="链接" align="center" prop="url" />
      <el-table-column label="乐观锁" align="center" prop="remark" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="父主键" prop="parentId">
          <el-input v-model="form.parentId" placeholder="请输入父主键" />
        </el-form-item>
        <el-form-item label="名字" prop="name">
        ...
        <el-form-item label="乐观锁" prop="remark">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除素材编号为"' + ids + '"的数据项？').then(function() {
