<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="groupedList" @selection-change="handleSelectionChange">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除顾问团队+企业荣誉编号为"' + ids + '"的数据项？').then(function() {
